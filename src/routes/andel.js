                        ...
                        overlay={
                          <Tooltip>
                            <p style={{ textAlign: 'left' }}>
                              ...
                              En kvalitativ binær variabel kan fx. være mænd og kvinder, tilfreds og utilfreds,
                              variabelt lån og fast lån etc.
                              <hr></hr>
                              Har man indsamlet en stikprøve med fx {b} respondenter angiver man dette antal i feltet
                              med stikprøvestørrelse, og ønsker at analysere andelen af tilfredse, optæller man antallet
                              af tilfredse som fx kunne være {a} disse intaster vi i feltet med successer.{' '}
                            </p>
                          </Tooltip>
                        }
                      >
                          ...
                          {show && b * p * (1 - p) < 9 && (
                            <>
                              <Alert variant="warning" onClose={() => setShow(false)} dismissible>
                                ...
                                analysen.<hr></hr>
                                <i>Se flere detaljer under forudsætninger:</i>
                              </Alert>
                            </>
                          )}
                        </>
