...
export default function datalivelearning() {
  return (
    <div>
      {' '}
          ...
          <div class="card">
            <div class="card-body">
              <div>
                ...
                <h6>Videoer fra vore Live Learning møder Smartlearning Værdiskabende dataanalyse og formidling</h6>
              </div>
            </div>
          </div>
        </div>
            ...
            <div class="card-body">
              <div className="embed-responsive embed-responsive-16by9">
                <iframe
                  ...
                  src="https://vimeo.com/showcase/10946116/embed"
                  frameborder="0"
